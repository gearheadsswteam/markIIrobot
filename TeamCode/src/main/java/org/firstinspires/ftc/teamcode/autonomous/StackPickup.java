...
@Autonomous(name = "StackPickup", group = "Right")
public class StackPickup extends AbstractAutonomous {
    ...
    Pose2d pickPose = new Pose2d(-60, 11, PI);
    ...
    public void initialize() {
        ...
        traj2 = robot.drive.trajectorySequenceBuilder(dropPose)
                ...
                .splineToLinearHeading(pickPose, PI)
                .addTemporalMarker(1, 0, () -> {
                    intakeTrajDone = true;
                })
                .build();

...
public class TrajectorySequenceBuilder {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineTo(Vector2d endPosition) {
        return addPath(() -> currentTrajectoryBuilder.lineTo(endPosition, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineTo(
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineToConstantHeading(Vector2d endPosition) {
        return addPath(() -> currentTrajectoryBuilder.lineToConstantHeading(endPosition, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineToConstantHeading(
            Vector2d endPosition,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineToLinearHeading(Pose2d endPose) {
        return addPath(() -> currentTrajectoryBuilder.lineToLinearHeading(endPose, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineToLinearHeading(
            Pose2d endPose,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineToSplineHeading(Pose2d endPose) {
        return addPath(() -> currentTrajectoryBuilder.lineToSplineHeading(endPose, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder lineToSplineHeading(
            Pose2d endPose,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder strafeTo(Vector2d endPosition) {
        return addPath(() -> currentTrajectoryBuilder.strafeTo(endPosition, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder strafeTo(
            Vector2d endPosition,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder forward(double distance) {
        return addPath(() -> currentTrajectoryBuilder.forward(distance, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder forward(
            double distance,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder back(double distance) {
        return addPath(() -> currentTrajectoryBuilder.back(distance, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder back(
            double distance,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder strafeLeft(double distance) {
        return addPath(() -> currentTrajectoryBuilder.strafeLeft(distance, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder strafeLeft(
            double distance,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder strafeRight(double distance) {
        return addPath(() -> currentTrajectoryBuilder.strafeRight(distance, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder strafeRight(
            double distance,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineTo(Vector2d endPosition, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineTo(endPosition, endHeading, currentVelConstraint, currentAccelConstraint));
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineTo(
            Vector2d endPosition,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineToConstantHeading(Vector2d endPosition, double endHeading) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineToConstantHeading(
            Vector2d endPosition,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineToLinearHeading(Pose2d endPose, double endHeading) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineToLinearHeading(
            Pose2d endPose,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineToSplineHeading(Pose2d endPose, double endHeading) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder splineToSplineHeading(
            Pose2d endPose,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ...
    private org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addPath(AddPathCallback callback) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder setTangent(double tangent) {
    ...
    private org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder setTangentOffset(double offset) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder setReversed(boolean reversed) {
        return reversed ? this.setTangentOffset(Math.toRadians(180.0)) : this.setTangentOffset(0.0);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder setConstraints(
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder resetConstraints() {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder setVelConstraint(TrajectoryVelocityConstraint velConstraint) {
        this.currentVelConstraint = velConstraint;

        return this;
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder resetVelConstraint() {
        this.currentVelConstraint = this.baseVelConstraint;

        return this;
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder setAccelConstraint(TrajectoryAccelerationConstraint accelConstraint) {
        this.currentAccelConstraint = accelConstraint;

        return this;
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder resetAccelConstraint() {
        this.currentAccelConstraint = this.baseAccelConstraint;

        return this;
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder setTurnConstraint(double maxAngVel, double maxAngAccel) {
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder resetTurnConstraint() {
        this.currentTurnConstraintMaxAngVel = baseTurnConstraintMaxAngVel;
        this.currentTurnConstraintMaxAngAccel = baseTurnConstraintMaxAngAccel;
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addTemporalMarker(MarkerCallback callback) {
        return this.addTemporalMarker(currentDuration, callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder UNSTABLE_addTemporalMarkerOffset(double offset, MarkerCallback callback) {
        return this.addTemporalMarker(currentDuration + offset, callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addTemporalMarker(double time, MarkerCallback callback) {
        return this.addTemporalMarker(0.0, time, callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addTemporalMarker(double scale, double offset, MarkerCallback callback) {
        return this.addTemporalMarker(time -> scale * time + offset, callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addTemporalMarker(TimeProducer time, MarkerCallback callback) {
        this.temporalMarkers.add(new TemporalMarker(time, callback));
        return this;
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addSpatialMarker(Vector2d point, MarkerCallback callback) {
        this.spatialMarkers.add(new SpatialMarker(point, callback));
        return this;
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addDisplacementMarker(MarkerCallback callback) {
        return this.addDisplacementMarker(currentDisplacement, callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder UNSTABLE_addDisplacementMarkerOffset(double offset, MarkerCallback callback) {
        return this.addDisplacementMarker(currentDisplacement + offset, callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addDisplacementMarker(double displacement, MarkerCallback callback) {
        return this.addDisplacementMarker(0.0, displacement, callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addDisplacementMarker(double scale, double offset, MarkerCallback callback) {
        return addDisplacementMarker((displacement -> scale * displacement + offset), callback);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addDisplacementMarker(DisplacementProducer displacement, MarkerCallback callback) {
        displacementMarkers.add(new DisplacementMarker(displacement, callback));

        return this;
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder turn(double angle) {
        return turn(angle, currentTurnConstraintMaxAngVel, currentTurnConstraintMaxAngAccel);
    }

    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder turn(double angle, double maxAngVel, double maxAngAccel) {
        pushPath();
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder waitSeconds(double seconds) {
        pushPath();
    ...
    public org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceBuilder addTrajectory(Trajectory trajectory) {
        pushPath();
